...
function [TotalTimeMIN]=runSmartQfire_7i_WND_INP_ConstWind_fmsk(Input_file)
%clear
tstart = clock;
...
MyExportFigPngStyle(f1,strcat(SaveNameMat,f1.Name), 'w30h25', FigSavePath)
MyExportFigPngStyle(f2,strcat(SaveNameMat,f2.Name), 'w30h12', FigSavePath)% 3 subplots convergence
F4Name=f4b.Name;
MyExportFigPngStyle(f4a,strcat(SaveNameMat,'AreesPlot'), 'w30h25', FigSavePath)
MyExportFigPngStyle(f4b,strcat(SaveNameMat,F4Name(13:end)), 'w30h25', FigSavePath)
