...
%
% HISTORY
% $20-06-16 Calculates RoS_i with slope
%
%
function[RoS_i,theta_w_s]=RothSlopeSI(U, PhiS0, D, SAV, Wo, Mf, Mx)

%------------ CONSTANT parameters-(from Scott & Burgan 2005---
...
% 10-hr dead fuel SAV is 109 1/ft, and 100-hr SAV is 30 1/ft. (how to input this?)
%------------------------------------------------------------
...
%NO TEMIM EN COMPTE TRANSFORMACIÖ DE PLANS! (see FARSITE pag 6)
