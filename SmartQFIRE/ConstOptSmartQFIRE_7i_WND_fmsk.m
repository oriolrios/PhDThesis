...
function [x,fval,Invarians,CostVal] = ConstOptSmartQFIRE_7i_WND_fmsk(xy_real,aspectA,slopeA,fmask,AllSpeedMapStrucGRD,AllDirMapStrucGRD,weight,At,I,OptIndexCh,dt,res,fId,ParallelPool)
    Invarians = [];
    CostVal = [];
...
%     equalities ceq(x) defined in nonlcon. 
    f=@(v) cost2opt_7i_WND_fmsk(v,xy_real{1},xy_real,aspectA,slopeA,fmask,AllSpeedMapStrucGRD,AllDirMapStrucGRD,weight,At,OptIndexCh,dt,res,fId);
