...
%
%
function [xy_fronts]=expansion_f_s_simple_7i_WND(Mf,Mx,SAV,Wo,MesoU,MesoDir,fuelDepth,xiyi,aspect,slope,AllSpeedMapStrucGRD,AllDirMapStrucGRD,At,dt,res)
tic
...
%!  Dummy és necessary ?
    ...
    [dummy]=huygns_integration_s_7i_WND(last_front2expand(:,1),last_front2expand(:,2),Mf,Mx,SAV,Wo,fuelDepth,aspect,slope,NewSpeedMapGRD,NewDirMapGRD,At(t)-At(t-1),dt,res);
