function CostFuncValue=cost2opt_all(v,xiyi,xy_real,fuel_depth,aspect,slope,weight,dt,OptIndexCh,fId)
%
...
[xy_model]=expansion_f_s_simple_all(I_Wo,Mf,Mx,U,SAV,theta,xiyi,fuel_depth,aspect,slope,dt);                               
