...
% **************** %
OptIndexCh='CostArea';   % 'CostArea','SDI','Sorensen','Jaccard','SDI_a','Sorensen_a','Jaccard_a';
% ---------------- %
...
[x, fval, Invariants, CostVal] = ConstOptSmartQFIRE_all(xy_real,fuel,aspect,slope,weight,realAdTime,I,OptIndexCh,fId);


fclose(fId);
%% Recomput initial fronts
[xy_model_ini_guess]=expansion_f_s_simple(I(1),I(2),I(3),I(4),I(5),I(6),xy_real{1},fuel,aspect,slope,realAdTime);
