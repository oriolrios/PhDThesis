function [xyout]=huygns_integration_s_all(x,y,I_Wo,Mf,Mx,U,SAV,wind_dir,fuel_depth,aspect,slope,At)
...
%     [wind_dir_i]    =0.*ones(length(x),1);
    ...
    % NEW all variables
    [RoS_i,theta_w_s]=RothSlopeSI(U, slope_i, fuel_depth_i, SAV, I_Wo, Mf, Mx);
