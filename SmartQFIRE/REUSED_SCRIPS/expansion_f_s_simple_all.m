...
function [xy_fronts]=expansion_f_s_simple_all(I_Wo,Mf,Mx,U,SAV,theta,xiyi,fuel_depth,aspect,slope,dt)
...
%!  Dummy és necessary ?
    ...
    [dummy]=huygns_integration_s_all(last_front2expand(:,1),last_front2expand(:,2),I_Wo,Mf,Mx,U,SAV,wind_dir,fuel_depth,aspect,slope,dt(t)-dt(t-1));           
