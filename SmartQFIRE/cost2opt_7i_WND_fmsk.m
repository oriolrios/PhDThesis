function CostFuncValue=cost2opt_7i_WND_fmsk(v,xiyi,xy_real,aspect,slope,fmask,AllSpeedMapStrucGRD,AllDirMapStrucGRD,weight,At,OptIndexCh,dt,res,fId)
%
...
%matlab
 [xy_model]=expansion_f_s_simple_7i_WND_fmsk(Mf,Mx,SAV,L,U,theta,D,xiyi,aspect,slope,fmask,AllSpeedMapStrucGRD,AllDirMapStrucGRD,At,dt,res);                               
% C expansion                            
