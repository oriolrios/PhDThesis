...
function [x,fval,Invarians,CostVal] = ConstOptSmartQFIRE_7i_WN(xy_real,aspectA,slopeA,AllSpeedMapStrucGRD,AllDirMapStrucGRD,weight,At,I,OptIndexCh,dt,res,fId,ParallelPool)
    Invarians = [];
    CostVal = [];
...
%     equalities ceq(x) defined in nonlcon. 
    f=@(v) cost2opt_7i_WN(v,xy_real{1},xy_real,aspectA,slopeA,AllSpeedMapStrucGRD,AllDirMapStrucGRD,weight,At,OptIndexCh,dt,res,fId);
