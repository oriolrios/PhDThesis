...
function [xy_fronts]=expansion_f_s_simple_7i_WN(Mf,Mx,SAV,Wo,MesoU,MesoDir,fuelDepth,xiyi,aspect,slope,AllSpeedMapStrucGRD,AllDirMapStrucGRD,At,dt,res)
tic
...
%!  Dummy és necessary ?
    ...
    [dummy]=huygns_integration_s_7i_WN(last_front2expand(:,1),last_front2expand(:,2),Mf,Mx,SAV,Wo,MesoU,MesoDirN,fuelDepth,aspect,slope,AllSpeedMapStrucGRD,AllDirMapStrucGRD,At(t)-At(t-1),dt,res);
