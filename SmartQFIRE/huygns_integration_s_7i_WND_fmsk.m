function [xyout]=huygns_integration_s_7i_WND_fmsk(x,y,Mf,Mx,SAV,Wo,Depth,aspect,slope,fmask,NewSpeedMapGRD,NewDirMapGRD,At,dt, res)
...
%     y=xy(:,2);
    ...
    [fuel_msk_i]    =getGRDvalue_simple(fmask,x,y); % 1 if combustible 0 if no. 
  ...
  %% NO COMBUSTIBILITY
  RoS_i=RoS_i.*fuel_msk_i; %(0 ROS points within a non combustible front
    % OLD
