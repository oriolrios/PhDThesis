function CostFuncValue=cost2opt_7i_WN(v,xiyi,xy_real,aspect,slope,AllSpeedMapStrucGRD,AllDirMapStrucGRD,weight,At,OptIndexCh,dt,res,fId)
%
...
%matlab
 [xy_model]=expansion_f_s_simple_7i_WN(Mf,Mx,SAV,L,U,theta,D,xiyi,aspect,slope,AllSpeedMapStrucGRD,AllDirMapStrucGRD,At,dt,res);                               
% C expansion                            
