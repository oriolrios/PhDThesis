...
% #####################################################
% DO NOT USE THIS. USE runExpansion_7i_WND_INP() instead
% #####################################################
%
...
function [xy_fronts]=runExpansion_7i_WN_INP(Input_file)
tstart = cputime;
...
%% EXPAN
[xy_fronts]=expansion_f_s_simple_7i_WN(I(1),I(2),I(3),I(4),I(5),I(6),I(7),xiyi,aspect,slope,AllSpeedMapStrucGRD,AllDirMapStrucGRD,realAdTime, dt, res);
...
if plotting==1
 %% SEPARATE FIGURES
    ...
    figure('Name', 'FrontsOnly'); 
    plot_fronts_cell(xy_fronts.xy,'hold','--r')
%     sH1=subplot(1,2,1);
%         slopeGrad=slope;
