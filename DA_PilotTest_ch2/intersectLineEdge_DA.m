...
%   lines LINE and edge EDGE. LINE is a 1x5 array containing parametric
...
%   coordinate of second point. P is the intersection point [xi yi] (1x2)
%   
...
point   = [xi' yi'];
out     = find(~isPointOnEdge(point, edge,1e-12));
