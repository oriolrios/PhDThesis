...
function [xy_fronts]=expansion_f_s_simple(Imfw,I_Wo,U,theta,xiyi,fuel_depth,aspect,slope,dt)
%% INPUTS
% INVARIANTS
%       Imfw        Wind-fuel
...
%!  Dummy és necessary ?
    ...
    %[dummy]=huygns_integration_s(last_front2expand(:,1),last_front2expand(:,2),Imfw,I_Wo,U,wind_dir,fuel_depth,aspect,slope,dt(t)-dt(t-1));
     [dummy]=huygns_integration_s(last_front2expand(:,1),last_front2expand(:,2),Imfw,I_Wo,U,wind_dir,fuel_depth,aspect,slope,dt(t));
