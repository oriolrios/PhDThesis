function [xout,yout]=direct_richards_int_WN_NaN(x,y,a,b,c,WS_dir_azhm_i,aspect_i,slope_i,dt)
...
% $01/08/2016 Same as direct_richards_int but with correct centered
% differences

[dxs,dys]=FrontCenteredDifferences_WN(x,y);
...
[dxs_L,dys_L]=horz2local_NaN(dxs,dys,aspect_i,slope_i);
