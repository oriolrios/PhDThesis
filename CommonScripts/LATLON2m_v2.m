function LATLON2m_v2()
% changes LAT LON axes of CURRENT FIGURE TO meters
%
% ORios 2016
a=gca;
%% PLOT INITIAL GUESS
% % load('c:\Users\orios\Dropbox\00. ThesisTEX\Manuscript\Chapter5_SmartQFIRE\figures\fig_OPT\Data2PLOTiniGuess.mat')
% % hold(a,'on')
% % h=plot_fronts_cell(xy_guess_des.xy,'hold','-g');
%uistack(h, 'bottom'); %send to back
%% reset labels
