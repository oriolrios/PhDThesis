 function hh = MyQuivercAuto(u,v,autoscaleMax)
...
%
% History (Orios);
%   $15.12.16 White bacground
%   $15.12.16 Plot CBAR and rescale it using Max_o to create comparable scales
%
...
if autoscale,
  ...
  %u = u*autoscale; v = v*autoscale; -> AUTOSCALED!!
end
...
%% Add colorbar and proper values
hC=colorbar;
% %find max
% 
%MaxDifTick=(ceil(Max_o)-Max_o)/Max_o;
% hC.Ticks=[0:(1+MaxDifTick)/10:1+MaxDifTick];
% hC.TickLabels=sprintf('%g\n',hC.Ticks.*Max_o);
% New
hC.TickLabels=sprintf('%2.2f\n',hC.Ticks./autoscaleMax);

hC.Label.String='Wind Speed [m/s]';
