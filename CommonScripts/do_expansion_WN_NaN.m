function [x,y]=do_expansion_WN_NaN(x,y,a,b,c,theta_w_s,aspect_i,slope_i,dt,res)
...
%     end
    [x,y]=direct_richards_int_WN_NaN(x,y,a,b,c,theta_w_s,aspect_i,slope_i,dt);
...
%   plot(x,y,'--+b');
    ...
    [xy]=degridding_vect(xy(:,1),xy(:,2),res);
%   plot(xy(:,1),xy(:,2),'--*g');
    
% Only for debugging
if length(xy)<3
    error('My:error: do_expansion_WN: stop. Numerical inconvergence (length(xy)<3)!')
end
