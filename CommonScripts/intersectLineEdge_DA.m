function [point]= intersectLineEdge_DA(line, edge)
% Adaptada Oriol 07/2014
%       Trec marca temporal (dt)
%       Afageixo distància
%
...
%   representation of the line and its time([x0 y0 dx dy ], see createLine for details).
%   EDGES is a 1x4 array containing corodiante of first point and
%   coordinate of second point [x1 y1 x2 y2]. POINT is the intersection point [xi yi] (1x2)
%   
...
point   = [xi' yi'];
out     = find(~isPointOnEdge(point, edge)); %això cal pq troba punts extrapolant que cal treure. ERA MASSA PRECÍS!!
